    ...
    <section className="bg-surface-low py-32">
      <div className="max-w-2xl mx-auto px-6 text-center">
        ...
        <p
          ...
          className="font-plus-jakarta text-base text-on-surface/60 mt-4 leading-relaxed"
        >
        ...
        <div ref={(el) => { elementsRef.current[2] = el; }} className="mt-10 flex flex-col md:flex-row gap-4 justify-center">
          <motion.a
            ...
            className="bg-[#25D366] text-white rounded-full px-8 py-4 font-plus-jakarta text-base font-medium flex items-center justify-center gap-2 w-full md:w-auto"
            whileHover={{
              scale: 1.03,
              boxShadow: '0 20px 40px rgba(37,211,102,0.30)',
              transition: { duration: 0.22 }
            }}
            style={{ boxShadow: '0 8px 24px rgba(37,211,102,0.20)' }}
          >
          ...
          <motion.a
            ...
            className="rounded-full px-8 py-4 font-plus-jakarta text-base text-primary w-full md:w-auto flex items-center justify-center"
            style={{ background: 'rgba(40,53,28,0.08)' }}
